...
public abstract class XC_MethodReplacement extends XC_MethodHook {
	 ...
	 */
	public static final XC_MethodReplacement DO_NOTHING = new XC_MethodReplacement(CompatHookBridge.PRIORITY_HIGHEST * 2) {
		@Override
	...
	public static XC_MethodReplacement returnConstant(final Object result) {
		return returnConstant(CompatHookBridge.PRIORITY_DEFAULT, result);
	}
