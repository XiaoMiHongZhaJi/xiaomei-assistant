...
public class XposedBridge {
    ...
    private static CompatHookBridge requireHookBridge() {
        CompatHookBridge hookBridge = StartupInfo.getHookBridge();
        if (hookBridge == null) {
    ...
    public static XC_MethodHook.Unhook hookMethod(Member hookMethod, XC_MethodHook callback) {
        ...
        CompatHookBridge hookBridge = requireHookBridge();
        CompatHookBridge.MemberHookCallback wrappedCallback = new WrappedCallbacks.WrappedHookCallback(callback);
        CompatHookBridge.MemberUnhookHandle unhookHandle = hookBridge.hookMethod(hookMethod, wrappedCallback, priority);
