...
public abstract class XC_MethodHook {
    ...
    public XC_MethodHook() {
        priority = CompatHookBridge.PRIORITY_DEFAULT;
    }
    ...
    public static class Unhook {
        ...
        private final CompatHookBridge.MemberUnhookHandle unhookHandle;
        private final XC_MethodHook callback;

        /*package*/ Unhook(CompatHookBridge.MemberUnhookHandle unhookHandle, XC_MethodHook callback) {
